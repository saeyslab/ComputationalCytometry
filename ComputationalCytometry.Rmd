...
df_g$Feature <- factor(x = df_g$Feature,
                       levels = c("%MC1: B cells", "%MC2: B cells", 
                                  "%MC3: Macrophages and unlabeld", "%MC4: Macrophages", 
                                  "%MC5: Neutrophils", "%MC6: DCs", "%MC7: Unlabeled", 
                                  "%MC8: Unlabeled", "%MC9: NK cells", "%MC10: T cells"))
